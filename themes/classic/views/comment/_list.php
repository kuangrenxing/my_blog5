...
<img src="<?php echo Yii::app()->baseUrl.'/uploads/avatar/'.(isset($model->author->avatar)?$model->author->avatar:Yii::app()->params['noAvatar']); ?>" alt="<?php echo isset($model->author->username)?$model->author->username:$model->authorName; ?>" title="<?php echo isset($model->author->username)?$model->author->username:$model->authorName; ?>" />

</div>
<div class="info">
<div class="author"><?php echo (isset($model->author->username)?CHtml::link($model->author->username,array('user/show','id'=>$model->author->id)):$model->authorName); ?></div>
<div class="time">
...
<?php echo (isset($model->author->email)?$model->author->email:$model->email); ?>
