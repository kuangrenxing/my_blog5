...
<h2><?php echo Yii::t('lan','New File');?>
<?php echo CHtml::link(Yii::t('lan','Manage Files'),array('admin'));?>
</h2>

<?php
$cs=Yii::app()->clientScript;
$cs->registerCSSFile(Yii::app()->request->baseUrl.'/js/swfupload/default.css');
$cs->registerScriptFile(Yii::app()->request->baseUrl.'/js/swfupload/swfupload.js');
$cs->registerScriptFile(Yii::app()->request->baseUrl.'/js/swfupload/swfupload.queue.js');
$cs->registerScriptFile(Yii::app()->request->baseUrl.'/js/swfupload/fileprogress.js');
$cs->registerScriptFile(Yii::app()->request->baseUrl.'/js/swfupload/handlers.js');
?>
