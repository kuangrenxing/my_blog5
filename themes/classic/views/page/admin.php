<h2>
<?php echo Yii::t('lan','Manage Pages');?><?php echo CHtml::link(Yii::t('lan','New Page'),array('create'));?>
</h2>
...
<tr class="<?php echo $n%2?'even':'odd'; ?>"> 
    <td>
        ...
        <td><?php echo (($model->author->username)?CHtml::link($model->author->username, array('user/show','id'=>$model->authorId)):
        $model->authorName);?></td>
