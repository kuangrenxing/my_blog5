...
<?php echo CHtml::encode($model->title);?>
    ...
    <div class="author">
        ...
        <?php endif;?>
    <?php echo Yii::t('lan','posted by');?><?php echo (($model->author->username)? CHtml::link($model->author->username,array('user/show','id'=>$model->authorId)):
        $model->authorName).' '.
...
<?php echo CHtml::linkButton(Yii::t('lan','Delete'),array(
    ...
    <?php endif;?>
<?php echo Yii::t('lan','Lase updated on');?>
