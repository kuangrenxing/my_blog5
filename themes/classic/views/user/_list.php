...
<div class="avatar"> <img src="<?php echo Yii::app()->baseUrl.'/uploads/avatar/'.(($model->avatar) ? $model->avatar:Yii::app()->params['noAvatar']); ?>" alt="<?php echo $model->username; ?>" title="<?php echo $model->username; ?>" /> </div>
<div class="info">
...
<div> 
    ...
    <?php echo CHtml::ajaxLink($model->bannedText,$this->createUrl('user/ajaxBanned',array('id'=>$model->id)),
